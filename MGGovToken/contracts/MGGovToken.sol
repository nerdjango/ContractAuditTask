...
contract MockGovToken is BEP20("MockGovToken", "MGToken") {
    ...
    function _moveDelegates(
        ...
        require(srcRep != dstRep, "MGToken::_moveDelegates: source address can not be equal destination address");
        require(amount > 0, "MGToken::_moveDelegates: amount can not be zero: ");
        if (srcRep != address(0)) {
